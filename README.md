...
- **Tier 1 (Higher Income / Higher Spending):** This cluster includes states like Maryland, Vermont, New Hampshire, and Virginia, which combine above-average household incomes with high per-pupil spending. These states generally have strong tax bases and a history of prioritizing education funding.
- **Tier 2 (Mid Income / Moderate Spending):** This middle cluster captures states like Ohio, Michigan, Pennsylvania, and Colorado that fall near the national average on both dimensions. These states represent the typical relationship between income and spending.
