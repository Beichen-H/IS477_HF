...
# Map numeric clusters to descriptive socioeconomic profiles
cluster_mapping = {
    0: 'Tier 3: Lower Income / Lower Spending',
    1: 'Tier 1: Higher Income / Higher Spending',
    2: 'Tier 2: Mid Income / Moderate Spending'
}
df['Cluster_Label'] = df['Cluster'].map(cluster_mapping)

# Save the dataset with appended cluster labels
